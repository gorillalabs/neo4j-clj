...
(defmacro with-connection
          ...
          (let [connection (gensym)]
               (list 'let [connection (list 'commons.neo4j.core/connect (list :url db) (list :username db) (list :password db))]
                     (list 'commons.neo4j.core/with-transaction connection tx-identifier expr))))
